...
function init()
  ...
  character_class_strings = {
    ['vagrant'] = '[fg]탐험가, Psyker',
    ['swordsman'] = '[yellow]전사',
    ['wizard'] = '[blue]마법사, [red]누커',
    ['magician'] = '[blue]마법사',
    ['archer'] = '[green]레인저',
    ['scout'] = '[red]도적',
    ['cleric'] = '[green]힐러',
    ['outlaw'] = '[yellow]전사, [red]도적',
    ['blade'] = '[yellow]전사, [red]누커',
    ['elementor'] = '[blue]마법사, [red]누커',
    -- ['saboteur'] = '[red]도적, [orange]컨저러, [red]누커',
    ['bomber'] = '[red]누커, [orange]빌더',
    ['stormweaver'] = '[blue]인챈터',
    ['sage'] = '[red]누커, [yellow]포서',
    ['squire'] = '[yellow]전사, [blue]인챈터',
    ['cannoneer'] = '[green]레인저, [red]누커',
    ['dual_gunner'] = '[green]레인저, [red]도적',
    -- ['hunter'] = '[green]레인저, [orange]컨저러, [yellow]포서',
    ['sentry'] = '[green]레인저, [orange]빌더',
    ['chronomancer'] = '[blue]마법사, Enchanter',
    ['spellblade'] = '[blue]마법사, [red]도적',
    ['psykeeper'] = '[green]힐러, [fg]사이커',
    ['engineer'] = '[orange]빌더',
    ['plague_doctor'] = '[red]누커, [purple]보이드',
    ['barbarian'] = '[purple]커서, [yellow]전사',
    ['juggernaut'] = '[yellow]포서, Warrior',
    ['lich'] = '[blue]마법사',
    ['cryomancer'] = '[blue]마법사, [purple]보이드',
    ['pyromancer'] = '[blue]마법사, [red]누커, [purple]보이드',
    ['corruptor'] = '[green]레인저, [orange]스워머',
    ['beastmaster'] = '[red]도적, [orange]스워머',
    ['launcher'] = '[yellow]포서, [purple]커서',
    ['jester'] = '[purple]커서, [red]도적',
    ['assassin'] = '[red]도적, [purple]보이드',
    ['host'] = '[orange]스워머',
    ['carver'] = '[orange]빌더, [green]힐러',
    ['bane'] = '[purple]커서, Voider',
    ['psykino'] = '[blue]마법사, [fg]사이커, [yellow]포서',
    ['barrager'] = '[green]레인저, [yellow]포서',
    ['highlander'] = '[yellow]전사',
    ['fairy'] = '[blue]인챈터, [green]힐러',
    ['priest'] = '[green]힐러',
    ['infestor'] = '[purple]커서, [orange]스워머',
    ['flagellant'] = '[fg]사이커, [blue]인챈터',
    ['arcanist'] = '[blue2]소서러',
    -- ['illusionist'] = '[blue2]소서러, [orange]컨저러',
    ['artificer'] = '[blue2]소서러, [orange]빌더',
    ['witch'] = '[blue2]소서러, [purple]보이드',
    ['silencer'] = '[blue2]소서러, [purple]커서',
    ['vulcanist'] = '[blue2]소서러, [red]누커',
    ['warden'] = '[blue2]소서러, [yellow]포서',
    ['psychic'] = '[blue2]소서러, [fg]사이커',
    ['miner'] = '[yellow2]머서너리',
    ['merchant'] = '[yellow2]머서너리',
    ['usurer'] = '[purple]커서, [yellow2]머서너리, [purple]보이드',
    ['gambler'] = '[yellow2]머서너리, [blue2]소서러',
    ['thief'] = '[red]도적, [yellow2]머서너리',
  }
  ...
  character_effect_names = {
    ...
    ['outlaw'] = '[red]비수 부메랑',
    ['blade'] = '[yellow]검날 공명',
    ['elementor'] = '[blue]바람의 장판',
    ['saboteur'] = '[orange]폭파병',
    ['bomber'] = '[orange]폭파병',
    ['stormweaver'] = '[blue]광역 번개',
    ['sage'] = '[purple]차원 압축',
    ['squire'] = '[yellow]빛나는 장비',
    ['cannoneer'] = '[orange]포격 난사',
    ['dual_gunner'] = '[green]건 카타',
    ['hunter'] = '[green]야수 떼',
    ['sentry'] = '[green]파수병 난사',
    ['chronomancer'] = '[blue]시간 가속',
    ['spellblade'] = '[blue]나선사격',
    ['psykeeper'] = '[fg]크루시오',
    ['engineer'] = '[orange]업그레이드!!!',
    ['plague_doctor'] = '[purple]흑사 스팀',
    ['barbarian'] = '[yellow]지진',
    ['juggernaut'] = '[yellow]잔혹한 일격',
    ['lich'] = '[blue]쇄빙',
    ['cryomancer'] = '[blue]동상',
    ['pyromancer'] = '[red]발화',
    ['corruptor'] = '[orange]타락',
    ['beastmaster'] = '[red]야생의 부름',
    ['launcher'] = '[orange]운동 에너지',
    ['jester'] = "[red]대혼란",
    ['assassin'] = '[purple]독 배달',
    ['host'] = '[orange]침공',
    ['carver'] = '[green]세계수',
    ['bane'] = '[purple]악몽',
    ['psykino'] = '[fg]자기력',
    ['barrager'] = '[green]포격',
    ['highlander'] = '[yellow]물리네트',
    ['fairy'] = '[green]변덕',
    ['priest'] = '[green]신의 개입',
    ['infestor'] = '[orange]감염',
    ['flagellant'] = '[red]광신',
    ['arcanist'] = '[blue2]비전 구슬',
    ['illusionist'] = '[blue2]환영 분신',
    ['artificer'] = '[blue2]주문 효율',
    ['witch'] = '[purple]죽음의 웅덩이',
    ['silencer'] = '[blue2]비전 저주',
    ['vulcanist'] = '[red]용암 분출',
    ['warden'] = '[yellow]자기장',
    ['psychic'] = '[fg]정신타격',
    ['miner'] = '[yellow2]황금 볼트',
    ['merchant'] = '[yellow2]아이템 상점',
    ['usurer'] = '[purple]파산',
    ['gambler'] = '[yellow2]다중 시전',
    ['thief'] = '[red]울트라킬',
  }

  character_effect_names_gray = {
    ['vagrant'] = '[light_bg]경험치 강화',
    ['swordsman'] = '[light_bg]휩쓸기',
    ['wizard'] = '[light_bg]마법 미사일',
    ['magician'] = '[light_bg]빠른 시전',
    ['archer'] = '[light_bg]바운스 샷',
    ['scout'] = '[light_bg]단도 공명',
    ['cleric'] = '[light_bg]대규모 치유 ',
    ['outlaw'] = '[light_bg]비수 부메랑',
    ['blade'] = '[light_bg]검날 공명',
    ['elementor'] = '[light_bg]바람의 장판',
    ['saboteur'] = '[light_bg]폭파병',
    ['bomber'] = '[light_bg]폭파병',
    ['stormweaver'] = '[light_bg]광역 번개',
    ['sage'] = '[light_bg]차원 압축',
    ['squire'] = '[light_bg]빛나는 장비',
    ['cannoneer'] = '[light_bg]포격 난사',
    ['dual_gunner'] = '[light_bg]건 카타',
    ['hunter'] = '[light_bg]야수 떼',
    ['sentry'] = '[light_bg]파수병 난사',
    ['chronomancer'] = '[light_bg]시간 가속',
    ['spellblade'] = '[light_bg]나선사격',
    ['psykeeper'] = '[light_bg]크루시오',
    ['engineer'] = '[light_bg]업그레이드!!!',
    ['plague_doctor'] = '[light_bg]흑사 스팀',
    ['barbarian'] = '[light_bg]지진',
    ['juggernaut'] = '[light_bg]잔혹한 일격',
    ['lich'] = '[light_bg]쇄빙',
    ['cryomancer'] = '[light_bg]동상',
    ['pyromancer'] = '[light_bg]발화',
    ['corruptor'] = '[light_bg]타락',
    ['beastmaster'] = '[light_bg]야생의 부름',
    ['launcher'] = '[light_bg]운동 에너지',
    ['jester'] = "[light_bg]대혼란",
    ['assassin'] = '[light_bg]독 배달',
    ['host'] = '[light_bg]침공',
    ['carver'] = '[light_bg]세계수',
    ['bane'] = '[light_bg]악몽',
    ['psykino'] = '[light_bg]자기력',
    ['barrager'] = '[light_bg]포격',
    ['highlander'] = '[light_bg]물리네트',
    ['fairy'] = '[light_bg]변덕',
    ['priest'] = '[light_bg]신의 개입',
    ['infestor'] = '[light_bg]감염',
    ['flagellant'] = '[light_bg]광신',
    ['arcanist'] = '[light_bg]비전 구슬',
    ['illusionist'] = '[light_bg]환영 분신',
    ['artificer'] = '[light_bg]주문 효율',
    ['witch'] = '[light_bg]죽음의 웅덩이',
    ['silencer'] = '[light_bg]비전 저주',
    ['vulcanist'] = '[light_bg]용암 분출',
    ['warden'] = '[light_bg]자기장',
    ['psychic'] = '[light_bg]정신타격',
    ['miner'] = '[light_bg]황금 볼트',
    ['merchant'] = '[light_bg]아이템 상점',
    ['usurer'] = '[light_bg]파산',
    ['gambler'] = '[light_bg]다중 시전',
    ['thief'] = '[light_bg]울트라킬',
  }
